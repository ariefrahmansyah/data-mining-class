...
class Scraper:
    def __init__(self):
        ...
        self.driver = webdriver.Chrome(options=options, service="chromedriver")
        ...
        for page in range(10):
            ...
            for item in soup.find_all("div", class_="css-974ipl"):
                ...
                product_name = item.find(
                    "div", class_="prd_link-product-name css-3um8ox"
                ).text
                price = item.find(
                    "div", class_="prd_link-product-price css-1ksb19c"
                ).text
                ...
                sold_items = item.find_all(
                    "span", class_="prd_label-integrity css-1duhs3e"
                )
                if len(sold_items) > 0:
                    sold = item.find(
                        "span", class_="prd_label-integrity css-1duhs3e"
